...
systemctl list-timers policy-monitor-collector.timer policy-monitor-historical.timer --all
journalctl -u policy-monitor.service -u policy-monitor-historical.service --since today --no-pager
```
