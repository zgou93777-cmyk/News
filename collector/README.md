...
Export a bounded, read-only review bundle before editing a review file:

```bash
node src/cli.js --historical-review-export /secure/review-bundles/cohort-1 --max-items 100
```
